...
DEFINE_BITFIELD(obj_rotation_flags, list(
	BITFIELD_NEW("Enabled", OBJ_ROTATION_ENABLED),
	BITFIELD_NEW("Defaulting", OBJ_ROTATION_DEFAULTING),
	BITFIELD_NEW("Allow Anchored", OBJ_ROTATION_NO_ANCHOR_CHECK),
	BITFIELD_NEW("Counterclockwise", OBJ_ROTATION_CCW),
	BITFIELD_NEW("Show Both Directions", OBJ_ROTATION_BIDIRECTIONAL),
))
