...
#define OBJ_PERSIST_DEFAULT_TUNING_DEBRIS_IMPORTANT_DROP_CHANCE 0
...
#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_MOST_ISOLATED 0
#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_LEAST_ISOLATED 5
...
//* turf grid persistence *//

/// chunk size
#define TURF_GRID_PERSIST_CHUNK_SIZE 16

//* turf grid persistence modes *//

/// persist dirt
#define TURF_GRID_PERSIST_MODE_DIRT (1<<0)
