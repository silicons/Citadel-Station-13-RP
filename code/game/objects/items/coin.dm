/**
 * Coins. These are just decorative, because we're not
 * using the goddamn gold standard in the 25th century.
 */
/obj/item/coin
...
/obj/item/coin/attack_self(mob/user, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
