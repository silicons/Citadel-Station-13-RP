...
/obj/item/card/id/synthetic/Initialize(mapload)
	. = ..()
	access = SSjob.access_ids_of_type(ACCESS_DOMAIN_STATION) + ACCESS_SPECIAL_SILICONS
...
/obj/item/card/id/centcom/Initialize(mapload)
	. = ..()
	access = SSjob.access_ids_of_type(ACCESS_DOMAIN_CENTCOM)

/obj/item/card/id/centcom/station/Initialize(mapload)
	. = ..()
	access |= SSjob.access_ids_of_type(ACCESS_DOMAIN_STATION)
