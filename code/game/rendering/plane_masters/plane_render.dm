...
/atom/movable/screen/plane_render
	...
	/// the relevant plane master id that we're pulling from - if this is not in the plane holder, we don't spawn.
	/// this can be weird for planes like parallax, so just make a best effort at making this make sense.
	var/relevant_plane
	#warn convert to id on spawn
...
/atom/movable/screen/plane_render/lighting_lightmask
	...
	relevant_plane = /atom/movable/screen/plane_master/lightmask
...
/atom/movable/screen/plane_render/darkvision_turfs
	...
	relevant_plane = /atom/movable/screen/plane_master/darkvision
