...
/obj/item/deadringer/proc/makeacorpse(var/mob/living/carbon/human/H)
	...
	if(H.item_by_slot_id(SLOT_ID_UNIFORM))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/under/chameleon/changeling(corpse), SLOT_ID_UNIFORM)
		temp = corpse.item_by_slot_id(SLOT_ID_UNIFORM)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_UNIFORM)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_SUIT))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/suit/chameleon/changeling(corpse), SLOT_ID_SUIT)
		temp = corpse.item_by_slot_id(SLOT_ID_SUIT)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_SUIT)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_SHOES))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/shoes/chameleon/changeling(corpse), SLOT_ID_SHOES)
		temp = corpse.item_by_slot_id(SLOT_ID_SHOES)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_SHOES)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_GLOVES))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/gloves/chameleon/changeling(corpse), SLOT_ID_GLOVES)
		temp = corpse.item_by_slot_id(SLOT_ID_GLOVES)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_GLOVES)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_LEFT_EAR))
		temp = H.item_by_slot_id(SLOT_ID_LEFT_EAR)
		corpse.equip_to_slot_or_del(new temp.type(corpse), SLOT_ID_LEFT_EAR)
		temp = corpse.item_by_slot_id(SLOT_ID_LEFT_EAR)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_GLASSES))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/glasses/chameleon/changeling(corpse), SLOT_ID_GLASSES)
		temp = corpse.item_by_slot_id(SLOT_ID_GLASSES)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_GLASSES)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_MASK))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/mask/chameleon/changeling(corpse), SLOT_ID_MASK)
		temp = corpse.item_by_slot_id(SLOT_ID_MASK)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_MASK)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_HEAD))
		corpse.equip_to_slot_or_del(new /obj/item/clothing/head/chameleon/changeling(corpse), SLOT_ID_HEAD)
		temp = corpse.item_by_slot_id(SLOT_ID_HEAD)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_HEAD)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_BELT))
		corpse.equip_to_slot_or_del(new /obj/item/storage/belt/chameleon/changeling(corpse), SLOT_ID_BELT)
		temp = corpse.item_by_slot_id(SLOT_ID_BELT)
		var/obj/item/clothing/c_type = H.item_by_slot_id(SLOT_ID_BELT)
		temp.disguise(c_type.type)
		ADD_TRAIT(temp, TRAIT_ITEM_NODROP, HOLOGRAM_TRAIT)
	if(H.item_by_slot_id(SLOT_ID_BACK))
		corpse.equip_to_slot_or_del(new /obj/item/storage/backpack/chameleon/changeling(corpse), SLOT_ID_BACK)
		temp = corpse.item_by_slot_id(SLOT_ID_BACK)
