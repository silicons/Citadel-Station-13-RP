...
/obj/machinery/computer/cryopod/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "CryoStorageVr", storage_name) // VOREStation Edit - Use our own template for our custom data
		ui.open()

/obj/machinery/computer/cryopod/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/obj/machinery/computer/cryopod/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return
