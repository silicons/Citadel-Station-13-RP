...
/world/proc/VgsNew(datum/tgs_event_handler/event_handler)
	...
	if(!config_legacy.vgs_access_identifier)
...
/datum/tgs_api/v5/vgs1/OnWorldNew()
	if(config_legacy.vgs_server_port)
		server_port = config_legacy.vgs_server_port
	access_identifier = config_legacy.vgs_access_identifier
