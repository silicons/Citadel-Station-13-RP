...
/datum/infomorph_software/crew_manifest/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
	if(data_core)
...
/datum/infomorph_software/med_records/ui_data(mob/living/silicon/infomorph/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/infomorph_software/med_records/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	. = ..()
...
/datum/infomorph_software/sec_records/ui_data(mob/living/silicon/infomorph/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/infomorph_software/sec_records/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	. = ..()
	var/mob/living/silicon/infomorph/P = usr
	if(!istype(P))
		return
...
/datum/infomorph_software/door_jack/ui_data(mob/living/silicon/infomorph/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/infomorph_software/door_jack/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	var/mob/living/silicon/infomorph/P = usr
	if(!istype(P) || ..())
		return TRUE
...
/datum/infomorph_software/atmosphere_sensor/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/infomorph_software/signaller/ui_data(mob/living/silicon/infomorph/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/infomorph_software/signaller/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
