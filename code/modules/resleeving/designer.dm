...
/obj/machinery/computer/transhuman/designer/ui_static_data(mob/user)
	var/list/data = ..()
	data["mapRef"] = map_name
	return data

/obj/machinery/computer/transhuman/designer/ui_data(mob/user)
	var/list/data = list()
...
/obj/machinery/computer/transhuman/designer/ui_act(action, params)
	if(..())
		return TRUE
