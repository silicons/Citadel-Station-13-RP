/obj/item/vehicle_module/weapon/ranged/legacy
	name = "mecha weapon"
	range = RANGED
...
/obj/item/vehicle_module/weapon/ranged/legacy/action_checks(atom/target)
	if(projectiles <= 0)
		return 0
	return ..()

/obj/item/vehicle_module/weapon/ranged/legacy/action(atom/target, params)
...
/obj/item/vehicle_module/weapon/ranged/legacy/proc/Fire(atom/A, atom/target, params)
...
/obj/item/vehicle_module/weapon/ranged/legacy/proc/process_accuracy(obj/projectile, mob/living/user, atom/target)
