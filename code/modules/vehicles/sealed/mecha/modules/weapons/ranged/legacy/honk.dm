...
/obj/item/vehicle_module/weapon/ranged/legacy/honker/action(target)
	if(!chassis)
		return 0
...
/obj/item/vehicle_module/weapon/ranged/legacy/ballistic/missile_rack/grenade/mousetrap
