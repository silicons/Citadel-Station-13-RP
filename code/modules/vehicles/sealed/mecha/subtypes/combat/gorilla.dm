...
/obj/vehicle/sealed/mecha/combat/gorilla/Initialize(mapload)
	...
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/weapon/ballistic/cannon(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/weapon/ballistic/cannon/weak(src) //Saves energy, I suppose. Anti-infantry.
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/weapon/ballistic/missile_rack/explosive(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/weapon/ballistic/lmg(src)
	ME.attach(src)
	return
...
/obj/item/vehicle_module/legacy/weapon/ballistic/mg42
