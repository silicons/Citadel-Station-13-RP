...
/obj/vehicle/sealed/mecha/combat/gorilla/Initialize(mapload)
	...
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/cannon(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/cannon/weak(src) //Saves energy, I suppose. Anti-infantry.
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/missile_rack/explosive(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/lmg(src)
	ME.attach(src)
	return
...
/obj/item/vehicle_module/weapon/ranged/ballistic/cannon
	name = "8.8cm KwK 47"
...
/obj/item/vehicle_module/weapon/ranged/ballistic/cannon/weak
	name = "8.8 cm KwK 36"
...
/obj/item/vehicle_module/weapon/ranged/ballistic/mg42
