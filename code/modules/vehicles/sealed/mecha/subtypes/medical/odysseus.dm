...
/obj/vehicle/sealed/mecha/medical/odysseus/loaded/Initialize(mapload)
	. = ..()
	var/obj/item/vehicle_module/ME = new /obj/item/vehicle_module/legacy/tool/sleeper
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/tool/sleeper
	ME.attach(src)
	ME = new /obj/item/vehicle_module/legacy/tool/syringe_gun
	ME.attach(src)
