...
/obj/item/vehicle_module/legacy/tool/sleeper/Exit(atom/movable/O)
	return FALSE
...
/datum/global_iterator/mech_sleeper/process(var/obj/item/vehicle_module/legacy/tool/sleeper/S)
	if(!S.chassis)
		S.set_ready_state(1)
		return stop()
