...
/obj/item/vehicle_module/component/armor/mining
...
/obj/item/vehicle_module/component/armor/reinforced
...
/obj/item/vehicle_module/component/armor/military/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
...
/obj/item/vehicle_module/component/armor/marshal
...
/obj/item/vehicle_module/component/armor/marshal/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/vehicle_module/component/armor/marshal/reinforced
...
/obj/item/vehicle_module/component/armor/military/marauder
...
/obj/item/vehicle_module/component/armor/military/marauder/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/vehicle_module/component/armor/alien/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
