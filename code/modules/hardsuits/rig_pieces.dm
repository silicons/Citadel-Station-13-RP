...
/obj/item/clothing/head/helmet/space/hardsuit
	...
	clothing_flags = CLOTHING_IS_THICK_MATERIAL | CLOTHING_HAS_INJECTION_PORT | ALLOW_SURVIVALFOOD | CLOTHING_IGNORE_BELTLINK | CLOTHING_IGNORE_DELIMB | ALLOWINTERNALS
...
/obj/item/clothing/gloves/gauntlets/hardsuit
	name = "gauntlets"
	clothing_flags = CLOTHING_IS_THICK_MATERIAL | CLOTHING_HAS_INJECTION_PORT | CLOTHING_IGNORE_BELTLINK | CLOTHING_IGNORE_DELIMB
	atom_flags = PHORONGUARD
...
/obj/item/clothing/head/lightrig
	name = "mask"
	clothing_flags = CLOTHING_IS_THICK_MATERIAL | CLOTHING_HAS_INJECTION_PORT | ALLOWINTERNALS | CLOTHING_IGNORE_BELTLINK | CLOTHING_IGNORE_DELIMB
	atom_flags = PHORONGUARD
	body_cover_flags = HEAD|FACE|EYES
	heat_protection_cover    = HEAD|FACE|EYES
	cold_protection_cover    = HEAD|FACE|EYES
