...
/datum/song/proc/playnote_legacy(note, acc as text, oct)
	...
	for(var/i in hearing_mobs)
		var/mob/M = i
		M.playsound_local(source, null, volume * using_instrument.volume_multiplier, falloff = 5, S = music_played, preference = /datum/game_preference_entry/toggle/sfx_instruments)
