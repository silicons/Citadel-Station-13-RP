...
/datum/song/proc/playkey_synth(key)
	...
	for(var/i in hearing_mobs)
		var/mob/M = i
		M.playsound_local(get_turf(parent), null, volume, FALSE, K.frequency, INSTRUMENT_DISTANCE_NO_FALLOFF, FALSE, channel, null, copy, /datum/game_preference_entry/toggle/sfx_instruments, distance_multiplier = INSTRUMENT_DISTANCE_FALLOFF_BUFF)
