...
/obj/machinery/account_database/ui_interact(mob/user, datum/tgui/ui)
...
/obj/machinery/account_database/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/obj/machinery/account_database/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
