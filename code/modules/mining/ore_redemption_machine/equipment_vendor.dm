...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("1000 Point Transfer Card",			/obj/item/weapon/card/mining_point_card/onethou,							1000),
		new /datum/data/mining_equipment("2000 Point Transfer Card",			/obj/item/weapon/card/mining_point_card/twothou,							2000),
		new /datum/data/mining_equipment("3000 Point Transfer Card",			/obj/item/weapon/card/mining_point_card/threethou,							3000),
