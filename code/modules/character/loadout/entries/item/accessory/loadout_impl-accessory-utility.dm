/datum/prototype/character_loadout_entry/accessory/brown_drop_pouches
	name = "Drop Pouches - Brown"
	path = /obj/item/clothing/accessory/storage/brown_drop_pouches
	cost = 2

/datum/prototype/character_loadout_entry/accessory/black_drop_pouches
	name = "Drop Pouches - Black"
	path = /obj/item/clothing/accessory/storage/black_drop_pouches
	cost = 2

/datum/prototype/character_loadout_entry/accessory/white_drop_pouches
	name = "Drop Pouches - White"
	path = /obj/item/clothing/accessory/storage/white_drop_pouches
	cost = 2

/datum/prototype/character_loadout_entry/accessory/holster_selection
	name = "Holster - Selection"
	path = /obj/item/clothing/accessory/holster

/datum/prototype/character_loadout_entry/accessory/holster_selection/New()
	..()
