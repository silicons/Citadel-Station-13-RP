/datum/prototype/character_loadout_entry/event_reward
...
/*
/datum/prototype/character_loadout_entry/event_reward/imperium       <------   Example Item
	name = "Imperium"
...
*/
/datum/prototype/character_loadout_entry/event_reward/gameboy
	name = "Game Boy"
	path = /obj/item/instrument/gameboy
	ckeywhitelist = list("jaybird1")

/datum/prototype/character_loadout_entry/event_reward/foxmimko
	name = "Miko Garb"
	path = /obj/item/clothing/under/event_reward/foxmiko
	slot = SLOT_ID_UNIFORM
	ckeywhitelist = list("knouli")

/datum/prototype/character_loadout_entry/event_reward/glue
...
/datum/prototype/character_loadout_entry/event_reward/fishingcap
	name = "Fishing Cap"
...
/datum/prototype/character_loadout_entry/event_reward/toadplush
	name = "Toad Plushie"
...
/datum/prototype/character_loadout_entry/event_reward/cooking_pin
...
/datum/prototype/character_loadout_entry/event_reward/petrock
	name = "Pet Rock"
	path = /obj/item/toy/plushie/petrock
	ckeywhitelist = list("cawingcrow")

/datum/prototype/character_loadout_entry/event_reward/nka_miaphus
...
/datum/prototype/character_loadout_entry/event_reward/tacskirt
	name = "Tactical Skirt"
	path = /obj/item/clothing/under/syndicate/skirt_pleated
	ckeywhitelist = list("grapepantasoda")

/datum/prototype/character_loadout_entry/event_reward/medmeritmedal
	name = "O2CM2 Medal"
