...
/datum/gear/plushie/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(plushies, /proc/cmp_string_asc, TRUE))
...
/datum/gear/lunchbox/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(lunchboxes, /proc/cmp_string_asc, TRUE))
