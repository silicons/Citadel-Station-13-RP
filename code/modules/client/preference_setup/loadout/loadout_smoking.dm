...
/datum/gear/pipe/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(pipes, /proc/cmp_text_asc, TRUE))
...
/datum/gear/lighter/zippo/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(zippos, /proc/cmp_text_asc, TRUE))
...
/datum/gear/cigarettes/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(cigarettes, /proc/cmp_text_asc, TRUE))
