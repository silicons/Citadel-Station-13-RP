...
/datum/gear/head/pin/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(pins, /proc/cmp_string_asc, TRUE))
...
/datum/gear/head/hardhat/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(hardhats, /proc/cmp_string_asc, TRUE))
...
/datum/gear/head/santahat/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(santahats, /proc/cmp_string_asc, TRUE))
...
/datum/gear/head/beret/sol/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(sols, /proc/cmp_string_asc, TRUE))*/ // Vorestation removal.
