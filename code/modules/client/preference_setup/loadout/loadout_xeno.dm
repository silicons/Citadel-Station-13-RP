...
/datum/gear/ears/skrell/chains/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(chaintypes, /proc/cmp_text_asc, TRUE))
...
/datum/gear/ears/skrell/bands/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(bandtypes, /proc/cmp_text_asc, TRUE))
...
/datum/gear/ears/skrell/cloth/short/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(shorttypes, /proc/cmp_text_asc, TRUE))
...
/datum/gear/ears/skrell/cloth/long/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(longtypes, /proc/cmp_text_asc, TRUE))
...
/datum/gear/uniform/smock/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(smocks, /proc/cmp_text_asc, TRUE))
...
/datum/gear/uniform/undercoat/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(undercoats, /proc/cmp_text_asc, TRUE))
...
/datum/gear/suit/cloak/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(cloaks, /proc/cmp_text_asc, TRUE))
...
/datum/gear/uniform/cohesionsuits/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(cohesionsuits, /proc/cmp_text_asc, TRUE))
