...
/datum/gear/accessory/armband/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(armbands, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/wcoat/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(wcoats, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/holster/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(holsters, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/tie/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(ties, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/scarf/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(scarfs, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/jacket/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(jackets, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/fannypack/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(fannys, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/sweater/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(sweaters, /proc/cmp_text_asc, TRUE))
...
/datum/gear/accessory/asym/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(timSort(asyms, /proc/cmp_text_asc, TRUE))
