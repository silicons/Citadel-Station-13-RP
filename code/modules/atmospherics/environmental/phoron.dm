/**
 * File straight transferred from base ZAS, has yet to be fully redone in a modular way
 *
 * todo:
 * generalized contamination vs just phoron
 * reworking contamination mechanics
 * full item contamination instead of just clothing
 */
