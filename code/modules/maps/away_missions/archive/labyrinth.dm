...
/obj/vehicle/sealed/mecha/combat/honker/cluwne/Initialize(mapload)
	. = ..()
	var/obj/item/vehicle_module/ME = new /obj/item/vehicle_module/weapon/ranged/energy/pulse
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/missile_rack/explosive
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/ballistic/missile_rack/banana_mortar
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/honker
	ME.attach(src)

/obj/item/vehicle_module/weapon/ranged/ballistic/missile_rack/banana_mortar
	name = "Banana Mortar"
