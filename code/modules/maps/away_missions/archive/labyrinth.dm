...
/obj/vehicle/sealed/mecha/combat/honker/cluwne/Initialize(mapload)
	. = ..()
	var/obj/item/vehicle_module/ME = new /obj/item/vehicle_module/weapon/ranged/legacy/energy/pulse
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/legacy/ballistic/missile_rack/explosive
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/legacy/ballistic/missile_rack/banana_mortar
	ME.attach(src)
	ME = new /obj/item/vehicle_module/weapon/ranged/legacy/honker
	ME.attach(src)

/obj/item/vehicle_module/weapon/ranged/legacy/ballistic/missile_rack/banana_mortar
	name = "Banana Mortar"
