...
/datum/chemical_reaction/instant/blob_reconstitution
...
/datum/chemical_reaction/instant/blob_reconstitution/can_happen(var/datum/reagents/holder)
	if(holder.my_atom && istype(holder.my_atom, /obj/item/blobcore_chunk))
		return ..()
	return FALSE

/datum/chemical_reaction/instant/blob_reconstitution/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/blob_reconstitution/domination
...
/datum/chemical_reaction/instant/blob_reconstitution/domination/on_reaction(var/datum/reagents/holder)
	var/obj/item/blobcore_chunk/chunk = holder.my_atom
