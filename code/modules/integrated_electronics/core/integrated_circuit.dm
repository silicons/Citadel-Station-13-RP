...
/obj/item/integrated_circuit/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/obj/item/integrated_circuit/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
