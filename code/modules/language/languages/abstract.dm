...
/datum/prototype/language/noise
...
/datum/prototype/language/noise/format_message_plain(message, verb)
	return message

/datum/prototype/language/noise/format_message_radio(message, verb)
	return "<span class='[colour]'>[message]</span>"

/datum/prototype/language/noise/get_talkinto_msg_range(message)
	// if you make a loud noise (screams etc), you'll be heard from 4 tiles over instead of two
	return (copytext(message, length(message)) == "!") ? 4 : 2

/datum/prototype/language/noise/can_speak_special(var/mob/speaker)
	return TRUE	//Audible emotes

// Silly language for those times when you try to talk a languague you normally can't
/datum/prototype/language/gibberish
...
/datum/prototype/language/gibberish/can_speak_special(var/mob/speaker)
