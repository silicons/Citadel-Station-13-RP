...
/datum/ai_holder/fsm/simple_mob/xenobio_slime
	hostile = TRUE
	cooperative = TRUE
	firing_lanes = TRUE
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/Destroy()
	grudges.Cut()
	..()

/datum/ai_holder/fsm/simple_mob/xenobio_slime/sapphire
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/light_pink
	discipline = 10
	obedience = 10

/datum/ai_holder/fsm/simple_mob/xenobio_slime/passive/New() // For Kendrick.
	..()
	pacify()

/datum/ai_holder/fsm/simple_mob/xenobio_slime/New()
	..()
	ASSERT(istype(holder, /mob/living/simple_mob/slime/xenobio))

// Checks if disciplining the slime would be 'justified' right now.
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/is_justified_to_discipline()
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/can_command(mob/living/commander)
	if(rabid)
		return FALSE
	if(!hostile)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/adjust_discipline(amount, silent)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/red/adjust_discipline(amount, silent)
	if(amount > 0 && !rabid)
		holder.say("Grrr...")
		holder.add_modifier(/datum/modifier/berserk, 30 SECONDS)
		enrage()

/datum/ai_holder/fsm/simple_mob/xenobio_slime/handle_special_strategical()
	discipline_decay()

// Handles decay of discipline.
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/discipline_decay()
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/handle_special_tactic()
	evolve_and_reproduce()

// Hit the correct verbs to keep the slime species going.
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/evolve_and_reproduce()
	var/mob/living/simple_mob/slime/xenobio/my_slime = holder
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/enrage()
	var/mob/living/simple_mob/slime/xenobio/my_slime = holder
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/proc/pacify()
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/pre_melee_attack(atom/A)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/closest_distance(atom/movable/AM)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/can_attack(atom/movable/AM)
	. = ..()
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/react_to_attack(atom/movable/attacker)
	. = ..(attacker)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/on_hear_say(mob/living/speaker, message)
...
/datum/ai_holder/fsm/simple_mob/xenobio_slime/can_violently_breakthrough()
