...
/datum/ai_holder/polaris/proc/engage_unseen_enemy()
...
/datum/ai_holder/polaris/proc/shoot_near_turf(turf/targeted_turf)
	if(!ranged)
		return // Can't shoot.
...
/datum/ai_holder/polaris/proc/melee_on_tile(turf/T)
