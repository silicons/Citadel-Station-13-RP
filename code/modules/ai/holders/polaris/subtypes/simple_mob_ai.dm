...
/datum/ai_holder/polaris/simple_mob
...
/datum/ai_holder/polaris/simple_mob/passive
	hostile = FALSE
	retaliate = FALSE
	can_flee = TRUE
...
/datum/ai_holder/polaris/simple_mob/inert/astar
	use_astar = TRUE

// Ranged mobs.

/datum/ai_holder/polaris/simple_mob/ranged
//	ranged = TRUE

//Attacks from twice normal range. Caution is far more resource intensive then standard.
/datum/ai_holder/polaris/simple_mob/ranged/sniper
	vision_range = 15
	max_range = 15

//Tries to stay well out of vision range. Caution is far more resource intensive then standard.
/datum/ai_holder/polaris/simple_mob/ranged/kiting/sniper
	vision_range = 15
	max_range = 15
	run_if_this_close = 10

// Tries to not waste ammo.
/datum/ai_holder/polaris/simple_mob/ranged/careful
	conserve_ammo = TRUE

/datum/ai_holder/polaris/simple_mob/ranged/pointblank
	pointblank = TRUE

// Runs away from its target if within a certain distance.
/datum/ai_holder/polaris/simple_mob/ranged/kiting
...
/datum/ai_holder/polaris/simple_mob/ranged/kiting/threatening
	threaten = TRUE
...
/datum/ai_holder/polaris/simple_mob/ranged/kiting/threatening/event
	base_wander_delay = 8

/datum/ai_holder/polaris/simple_mob/ranged/kiting/no_moonwalk
	moonwalk = FALSE
...
/datum/ai_holder/polaris/hostile/ranged/robust/on_engagement(atom/movable/AM)
	step_rand(holder)
	holder.face_atom(AM)
...
/datum/ai_holder/polaris/simple_mob/intentional


// These try to avoid collateral damage.
/datum/ai_holder/polaris/simple_mob/restrained
	violent_breakthrough = FALSE
	conserve_ammo = TRUE
	destructive = FALSE

// This does the opposite of the above subtype.
/datum/ai_holder/polaris/simple_mob/destructive
	destructive = TRUE
...
/datum/ai_holder/polaris/simple_mob/melee/hit_and_run/special_flee_check()
...
/datum/ai_holder/polaris/simple_mob/retaliate/cooperative
	cooperative = TRUE
