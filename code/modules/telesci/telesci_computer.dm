...
/obj/machinery/computer/telescience/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = list()
	if(!telepad)
...
/obj/machinery/computer/telescience/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
