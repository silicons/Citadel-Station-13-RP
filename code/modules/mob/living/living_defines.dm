...
/mob/living
	...
	//* Datastores - Enigmas *//
	#warn hook both
	/// clockwork physicality
	var/datum/clockwork_physicality/clockwork = new
	/// clockwork physiclaity modifiers
	var/list/datum/clockwork_physicality_modifier/clockwork_modifiers
