...
/mob/living/simple_mob/humanoid/cultist/hunter // This Mob is not meant to be fair, he is not meant to fight regular crew he is to be pitted against heavily armed explo teams to see if he can wipe them out.
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/ranged/aggressive/blood_hunter
...
/datum/ai_holder/fsm/simple_mob/ranged/aggressive/blood_hunter //This directs the AI to charge while shooting at its victim then entering Glorious melee combat.
	pointblank = FALSE
	closest_distance = 0
