...
/mob/living/simple_mob/animal/sif/sakimm
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/retaliate/cooperative/sakimm
...
/datum/ai_holder/fsm/simple_mob/retaliate/cooperative/sakimm/handle_special_strategical()	// Just needs to take hats.
...
/mob/living/simple_mob/animal/sif/sakimm/intelligent
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/intentional/sakimm
	randomize_size = FALSE	// Most likely to have a hat.

/datum/ai_holder/fsm/simple_mob/intentional/sakimm
	hostile = FALSE
	retaliate = TRUE
	vision_range = 10
	can_flee = TRUE
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/New()
	..()
	original_home_distance = max_home_distance

/datum/ai_holder/fsm/simple_mob/intentional/sakimm/post_melee_attack(atom/A)
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/list_targets()
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/find_target(var/list/possible_targets, var/has_targets_list = FALSE)
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/pre_melee_attack(atom/A)
	if(isliving(A))
		var/mob/living/L = A
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/should_go_home()
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/handle_special_tactic()
	var/mob/living/simple_mob/animal/sif/sakimm/S = holder
	if(S.hat)
		hoard_items = FALSE
	else
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/handle_special_strategical()
	var/mob/living/simple_mob/animal/sif/sakimm/S = holder
...
/datum/ai_holder/fsm/simple_mob/intentional/sakimm/special_flee_check()
