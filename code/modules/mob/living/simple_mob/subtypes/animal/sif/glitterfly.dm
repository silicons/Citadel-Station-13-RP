...
/mob/living/simple_mob/animal/sif/glitterfly
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/melee/evasive/glitterfly
...
/datum/ai_holder/fsm/simple_mob/melee/evasive/glitterfly
	hostile = FALSE
	can_flee = TRUE
...
/datum/ai_holder/fsm/simple_mob/melee/evasive/glitterfly/handle_special_strategical()
	if(prob(1))
