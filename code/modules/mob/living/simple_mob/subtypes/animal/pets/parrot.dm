...
/mob/living/simple_mob/animal/passive/bird/parrot
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/passive/parrot
...
// AI
/datum/ai_holder/fsm/simple_mob/passive/parrot
	speak_chance = 2
	base_wander_delay = 8

/datum/ai_holder/fsm/simple_mob/passive/parrot/on_hear_say(mob/living/speaker, message)
