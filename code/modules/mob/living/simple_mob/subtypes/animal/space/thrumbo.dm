/mob/living/simple_mob/animal/horing
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/horing
...
/mob/living/simple_mob/animal/horing/handle_special()
	if(ai_holder)
		if(istype(ai_holder, /datum/ai_holder/fsm/simple_mob/horing))
			var/datum/ai_holder/fsm/simple_mob/horing/changedAI = ai_holder
			var/mobtension = 0
...
/datum/ai_holder/fsm/simple_mob/horing
...
/datum/ai_holder/fsm/simple_mob/horing/find_target(list/possible_targets, has_targets_list)
...
/datum/ai_holder/fsm/simple_mob/horing/proc/checkthreatened(var/possible_target, var/target_threatlevel = 0)
...
/datum/ai_holder/fsm/simple_mob/horing/threaten_target()
