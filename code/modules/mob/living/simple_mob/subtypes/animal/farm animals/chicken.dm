...
/mob/living/simple_mob/animal/passive/chicken
	...
	ai_saylist_type = /datum/ai_saylist/polaris/chicken
...
/mob/living/simple_mob/animal/passive/chick
	...
	ai_saylist_type = /datum/ai_saylist/polaris/chick
...
// Say Lists
/datum/ai_saylist/polaris/chicken
	speak = list("Cluck!","BWAAAAARK BWAK BWAK BWAK!","Bwaak bwak.")
	emote_hear = list("clucks","croons")
	emote_see = list("pecks at the ground","flaps its wings viciously")

/datum/ai_saylist/polaris/chick
