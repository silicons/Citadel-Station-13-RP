/datum/prototype/struct/catalogue_entry/fauna/alien
	name = SPECIES_XENO
	...
	unlocked_by_any = list(/datum/prototype/struct/catalogue_entry/fauna/alien)

// Obtained by scanning all Aliens.
/datum/prototype/struct/catalogue_entry/fauna/all_aliens
	...
	unlocked_by_all = list(
		...
		/datum/prototype/struct/catalogue_entry/fauna/alien/drone
		)
...
/mob/living/carbon/alien
	...
	maxHealth = 100
	mob_size = 4
	catalogue_data_legacy = list(/datum/prototype/struct/catalogue_entry/fauna/alien/drone)
