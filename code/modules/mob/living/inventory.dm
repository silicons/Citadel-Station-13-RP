...
/mob/living/proc/show_inventory_panel(mob/user, datum/tgui_state/state)
	...
	inventory_panel.ui_interact(user, null, state)
...
/datum/inventory_panel/ui_host(mob/user)
	return host.ui_host()
...
/datum/inventory_panel/ui_interact(mob/user, datum/tgui/ui, datum/tgui_state/custom_state)
	if(!host)
		qdel(src)
		return
...
/datum/inventory_panel/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/inventory_panel/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
...
/datum/inventory_panel/human/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	if(..())
		return TRUE
...
/datum/inventory_panel/human/ui_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
