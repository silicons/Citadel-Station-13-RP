/datum/prototype/struct/catalogue_entry/fauna/silicon/robot/stray
	name = "Robot - Stray"
...
/mob/living/silicon/robot/stray
	...
	icon_selected = FALSE
	catalogue_data_legacy = list(/datum/prototype/struct/catalogue_entry/fauna/silicon/robot/stray)
